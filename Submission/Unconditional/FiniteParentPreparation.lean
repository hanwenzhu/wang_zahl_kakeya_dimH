...
import Submission.Unconditional.ConversionLogAbsorption
import Submission.Unconditional.DirectConversionStatement
import Submission.Unconditional.GeometryAdapters
import Submission.Kakeya.MultiScaleFac.GridUniformBand
import Submission.Kakeya.Tube.Dilate
import Submission.Unconditional.RelativeWeightedCore
import Submission.Unconditional.BalancedQuotientFrostman
import Submission.Unconditional.MergedClassFrostman
import Submission.Unconditional.CenteredUnitParent
import Submission.Unconditional.AtomCorePullback
import Submission.Unconditional.AtomMassFrostman
import Submission.Unconditional.WeightedTupleSelection
import Submission.Unconditional.FiniteParentRecords
import Submission.Unconditional.GeometricAtomInput
import Submission.Unconditional.OriginalAtomProjection
import Submission.Unconditional.AtomWeightLevel
import Submission.Unconditional.RestoredFineSupport
import Submission.Unconditional.GridCenteredParentCover
import Submission.Kakeya.DimensionThree.MainLemma2.ShadedDividingScales
  ...
  have hPreparationAtRadius {delta : NNReal} (hdelta : 0 < delta) (hsmall : delta ≤ 1 / 200)
    ...
    have hRefinedLine : Kakeya.VeryNotSticky.IsLineEssDistinct lineA fineSet
      ...
      have hsub : fineSet.filter (fun i => (refined i).carrier ⊆
        ...
        have hradius : 10 * ((delta / 2 : NNReal) : ℝ) = 5 * (delta : ℝ) := by
