...
public import Submission.Kakeya.DimensionThree.MainLemma2.TransverseCase
public import Submission.Kakeya.DimensionThree.MainLemma2.TangentialCase
public import Submission.Kakeya.DimensionThree.Plank.TypicalAngleIncidence
public import Submission.Kakeya.DimensionThree.Volume
public import Submission.Kakeya.Discretization
public import Submission.Kakeya.LEApprox
...
lemma volume_shade_plankRescale (ctr : EuclideanSpace ℝ (Fin 3)) {r₁ : ℝ} (hr₁ : 0 < r₁)
  ...
  have hshade : (W.plankRescale ctr hr₁.ne').shade = plankRescale ctr hr₁.ne' '' W.shade := by
    change
      (W.affineImage (plankRescale ctr hr₁.ne').toAffineMap _ _).shade =
        plankRescale ctr hr₁.ne' '' W.shade
    unfold ShadedBody.affineImage
