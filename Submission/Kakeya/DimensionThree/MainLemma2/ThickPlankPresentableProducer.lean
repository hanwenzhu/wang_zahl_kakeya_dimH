...
public import Submission.Kakeya.DimensionThree.MainLemma2.ThickPlankNormalise
public import Submission.Kakeya.DimensionThree.MainLemma2.ThickPlankSelect
public import Submission.Kakeya.DimensionThree.MainLemma2.LineEssDistinct
public import Submission.Kakeya.DimensionThree.MainLemma2.ThickPlankNonconc
public import Submission.Kakeya.DimensionThree.MainLemma2.ThickPlankFullness
public import Submission.Kakeya.DimensionThree.MainLemma2.ThickPlankFrostman
...
theorem thickPlankPresentable_of_ballData (cfg : VeryNotSticky.{u}) (bd : BallData cfg)
  ...
  have hKcar : ∀ p, ((K p).carrier : Set E₃) = L '' ((bd.Y p).carrier : Set E₃) := by
    ...
    exact Set.image_congr (by
      intro y _
      simp only [AffineEquiv.coe_toAffineMap])
