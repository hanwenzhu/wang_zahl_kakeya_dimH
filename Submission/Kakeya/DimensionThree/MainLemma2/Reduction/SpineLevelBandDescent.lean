...
public import Submission.Kakeya.DimensionThree.MainLemma2.Reduction.SpineDensityBandFromBin
public import Submission.Kakeya.DimensionThree.MainLemma2.Reduction.SpineDefectConstantLedger
...
variable {ι : Type v} {γ : Type*} {δ Cu : ℝ≥0} {u : Finset ι}
