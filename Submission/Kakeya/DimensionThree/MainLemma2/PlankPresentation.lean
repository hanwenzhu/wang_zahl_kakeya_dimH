...
public import Submission.Kakeya.ConvexBody.Counting
public import Submission.Kakeya.GreedyIndependentSet
...
public import Submission.Kakeya.DimensionThree.Plank
public import Submission.Kakeya.DimensionThree.Plank.Geometry
public import Submission.Kakeya.DimensionThree.Slab.Multiplicity
...
theorem plankRescaledFamily_spread {ω : Type*} (bodies' : Finset ω)
  ...
  have hcarrier : (((Wb j).plankRescale ctr (NNReal.coe_ne_zero.mpr hr₁.ne')).carrier : Set E₃)
    ...
    unfold ConvexSpaceBody.plankRescale ConvexSpaceBody.affineImage
    rfl
