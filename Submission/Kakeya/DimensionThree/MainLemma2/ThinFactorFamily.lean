...
public import Submission.Kakeya.Factoring.CoreAtScale
public import Submission.Kakeya.DimensionThree.MainLemma2.ThinCore
public import Submission.Kakeya.DimensionThree.MainLemma2.ThinCentredMult
public import Submission.Kakeya.DimensionThree.MainLemma2.ThinCellVolume
public import Submission.Kakeya.DimensionThree.MainLemma2.ThinFullness
...
lemma ethickness_image_add_left (v : E) (X : Set E) (n : ℕ) :
  ...
  have key : ∀ (w : E) (Y : Set E),
    ...
    have hL : LipschitzWith 1 ⇑((AffineEquiv.constVAdd ℝ E w).toAffineMap) := by
      ...
      intro x y
      simp only [AffineEquiv.coe_toAffineMap, AffineEquiv.constVAdd_apply, vadd_eq_add,
        dist_eq_norm, add_sub_add_left_eq_sub, NNReal.coe_one, one_mul]
      exact le_rfl
...
lemma thinFactorFamily_fiber (j : ω) :
  ...
  apply Finset.ext
  intro i
  rw [ShadedBody.FactorFamily.mem_fiber, Finset.mem_filter,
    thinFactorFamily_innerSet, thinFactorFamily_parent]
