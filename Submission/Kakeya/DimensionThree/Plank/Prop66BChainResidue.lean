...
public import Submission.Kakeya.DimensionThree.Plank.Section6PartBDataBridgeUniv
...
public import Submission.Kakeya.DimensionThree.Plank.Prop66BCoarseScale
...
theorem tubeMultiplicityOfGlobalPlankFactorisation_parentWindow_of_chainConstructed {β : ℝ}
  ...
  set D := Section6PartBData.ofUniformAtScaleOfGlobalPlankUniv' PS Fz hδρ hbr hb0 hρ0 hq hballs
    with hD_def
  have hD_factor : D.factor =
      Fz.toSection6PartBFactorisationFin Fz.one_le_Cw hb1 hb0 hρ0 hne hballs := by
    rw [hD_def]
    unfold Section6PartBData.ofUniformAtScaleOfGlobalPlankUniv'
    unfold Section6PartBData.ofUniformAtScaleOfGlobalPlankUniv
    rfl
