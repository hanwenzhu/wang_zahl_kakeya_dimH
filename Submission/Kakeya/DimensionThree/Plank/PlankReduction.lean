...
public import Submission.Kakeya.DimensionThree.Plank.RepresentativeShading
public import Submission.Kakeya.DimensionThree.Plank.AssignedSlabFamily
public import Submission.Kakeya.DimensionThree.Plank.AssignedSlabSelection
public import Submission.Kakeya.DimensionThree.Plank.SlabwiseOutputs
public import Submission.Kakeya.DimensionThree.Plank.SlabwiseTransport
public import Submission.Kakeya.DimensionThree.Plank.TypicalAngleIncidence
public import Submission.Kakeya.DimensionThree.Plank.ShadingAggregation
public import Submission.Kakeya.DimensionThree.Plank.PublicConstants
public import Submission.Kakeya.DimensionThree.Plank.StrongRefinementCoefficient
public import Submission.Kakeya.DimensionThree.Plank.Refinement
public import Submission.Kakeya.DimensionThree.Plank.SlabwiseReduction
...
theorem plankReduction :
  ...
  · -- the fibre bounds, transported by slab-completeness
    ...
    have hcard_eq :
        (s₁.filter (fun j =>
          (R.restrict hs₁sub).repr j = (R.restrict hs₁sub).repr i)).card =
          (s'.filter (fun j => R.repr j = R.repr i)).card := by
      congr 1
      calc
        s₁.filter (fun j =>
            (R.restrict hs₁sub).repr j = (R.restrict hs₁sub).repr i) =
            s₁.filter (fun j => R.repr j = R.repr i) := by
          apply Finset.filter_congr
          intro j _
          simp only [Plank.ThickenedRepr.restrict_repr]
        _ = s'.filter (fun j => R.repr j = R.repr i) := by
          dsimp only [s₁]
          exact hfibeq _ hQ
    rw [hcard_eq]
