...
public import Submission.Kakeya.DimensionThree.Plank.Section6PartBWiring
public import Submission.Kakeya.DimensionThree.Plank.PartBOuterFullnessInputs
public import Submission.Kakeya.DimensionThree.Plank.CollarPlankConflictDegree
...
theorem exists_threshold_constructedProp51Output {ηₒ e : ℝ} (hηₒ : 0 < ηₒ) (he : 0 < e) :
  ...
  · refine {
    ...
    · intro i
      ...
      constructor
      · intro hi
        have hiO := Finset.mem_filter.mp hi
        have hiF := Finset.mem_filter.mp hiO.1
        exact ⟨hiF.1, hiO.2⟩
      · rintro ⟨hq, hout⟩
        apply Finset.mem_filter.mpr
        refine ⟨Finset.mem_filter.mpr ⟨hq, ?_⟩, hout⟩
