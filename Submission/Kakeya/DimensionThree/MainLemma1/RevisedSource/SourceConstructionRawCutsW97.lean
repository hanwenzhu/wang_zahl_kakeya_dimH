...
public import Submission.Kakeya.DimensionThree.MainLemma1.RevisedSource.TrialEntryLemmasW94
public import Submission.Kakeya.Factoring.RhoTubesUndilated
public import Submission.Kakeya.Factoring.Pipeline
public import Submission.Kakeya.Tube.IntersectionVolume
public import Submission.Kakeya.Tube.Dilate
public import Submission.Kakeya.Factoring.OuterPacking
import all Submission.Kakeya.Factoring.Step1
  ...
  have hsupportComparable : ∀ Q ∈ active, ∀ Q' ∈ active,
    ...
    have hvalue : ∀ A ∈ active,
      ...
      · ext i
        constructor
        · intro hi
          have hi' := (ShadedFactorFamily.mem_fiber G5 A i).mp hi
          apply Finset.mem_filter.mpr
          simpa only [G5, FactorFamily.pipelineFamily_innerSet,
            FactorFamily.pipelineFamily_parent] using hi'
        · intro hi
          have hi' := Finset.mem_filter.mp hi
          apply (ShadedFactorFamily.mem_fiber G5 A i).mpr
          simpa only [G5, FactorFamily.pipelineFamily_innerSet,
            FactorFamily.pipelineFamily_parent] using hi'
      · intro i hi
