...
theorem IsFrostmanIn.of_volume_eq_zero {s : Finset ι} {W : ι → ConvexSpaceBody E}
    {K : ConvexSpaceBody E} {C : ℝ≥0∞} (hK : volume K.carrier = 0) :
...
variable {s : Finset ι} {K : ConvexSpaceBody E}
  ...
  calc
    ...
    _ = ((3 * Tube.le_volume.c (Module.finrank ℝ E) : ℝ≥0) : ℝ≥0∞) := by
          change ENNReal.ofReal
              ((((3 : ℝ≥0) * Tube.le_volume.c (Module.finrank ℝ E) : ℝ≥0) : ℝ)) =
            (((3 : ℝ≥0) * Tube.le_volume.c (Module.finrank ℝ E) : ℝ≥0) : ℝ≥0∞)
