...
public import Submission.Kakeya.RandomTranslation.RigidEDFail
public import Submission.Kakeya.RandomTranslation.RigidFrostmanGood
...
theorem badAgainstSet_of_notED_rigidProduct [Nontrivial E] (hδ : 0 < δ) (hδ1 : δ ≤ 1)
  ...
  have hlow_enn : ENNReal.ofReal c_low =
    ...
    congr 1
    have hδcoe : ENNReal.ofReal (δ : ℝ) = (δ : ℝ≥0∞) :=
      ENNReal.ofReal_coe_nnreal
    exact congrArg (fun z : ℝ≥0∞ => z ^ (Module.finrank ℝ E - 1))
      hδcoe
