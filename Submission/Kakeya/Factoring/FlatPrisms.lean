...
public import Submission.Kakeya.Factorization
public import Submission.Kakeya.Factoring.CoreLossEnvelope
public import Submission.Kakeya.Factoring.SelectScale
public import Submission.Kakeya.DimensionThree.IsometryTransport
public import Submission.Kakeya.DimensionThree.Plank.ComparableEnvelope
public import Submission.Kakeya.DimensionThree.Plank.DilatedParentCount
public import Submission.Kakeya.DimensionThree.Plank.EDWeightedExtraction
public import Submission.Kakeya.DimensionThree.Plank.EDParentCount
public import Submission.Kakeya.DimensionThree.Plank.FlatPrismInnerEstimate
public import Submission.Kakeya.DimensionThree.Plank.FrostmanPlankAuxScale
public import Submission.Kakeya.DimensionThree.Plank.PlankFactorizationEstimate
public import Submission.Kakeya.DimensionThree.Plank.ThickenedGeometry
public import Submission.Kakeya.DimensionThree.Plank.TubeEnclosure
public import Submission.Kakeya.PartialEstimates
...
theorem flatPrismFactorFamily_volumeRatio_dilate_controlled_exponent {ρ D : ℝ≥0}
  ...
  unfold flatPrismFactorFamily_volumeRatio_dilate_controlled
  rfl
  ...
  · have hβpos : 0 < β := lt_of_le_of_ne hβ0 (Ne.symm hβ)
    ...
    · let Fz' : ∀ k : FlatPrismParent t,
      ...
      have hGSfiber : ∀ j ∈ GS.outerSet, (GS.fiber j).Nonempty := by
        ...
        refine ⟨i, ?_⟩
        apply (ShadedBody.FactorFamily.mem_fiber GS j i).mpr
        constructor
        · change i ∈ (G.restrictOuter S.selected).innerSet
          rw [ShadedBody.FactorFamily.restrictOuter_innerSet]
          exact Finset.mem_filter.mpr ⟨hi, by simpa only [hip] using hjS⟩
        · change G.parent i = j
          exact hip
