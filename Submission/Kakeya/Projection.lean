...
public import Submission.Kakeya.Mathlib.Geometry.Projection
...
theorem orthogonalProjectionImage_le_iff
  ...
  change (V.carrier : Set E) ⊆ K.carrier ↔
    (V.orthogonalProjectionImage H).carrier ⊆ (K.orthogonalProjectionImage H).carrier
  have hπK_carrier :
